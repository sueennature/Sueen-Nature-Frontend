<template>
  <div class="lg:container px-4 py-20">
   ...
   <!-- sub title -->
    ...
    <div class="flex items-center justify-center md:mt-20 md:mb-10 my-6">
      ...
      <h2 class="md:text-4xl text-2xl uppercase text-black-200 mx-4 whitespace-pre">Single Room</h2>
      <span class="border-t border-black w-1/4 mx-4"></span>
    </div>
    ...
    <div class="flex flex-row gap-4 justify-center mt-2">
      ...
      <h5 class="md:text-sm text-xs text-black-200 border-l pl-4 mt-[6px]">Bed: 01 Queen</h5>
  ...
  <span class="mb-2 md:mb-0">View:</span>
  <select class="ml-0 md:ml-2 border rounded-sm text-xs h-8 px-2" v-model="view">
  ...
  <option value="lake">Lake</option>
    ...
    <div>
      ...
      <div class="flex flex-row gap-4 justify-center mt-2">
        ...
        <h5 class="md:text-sm text-xs text-black-200 border-l pl-4 mt-[6px]">Beds: 01 King</h5>
        <h5 class="md:text-sm text-xs text-black-200 border-l pl-4 mt-[6px]">
          Occupancy: 02 Adults / 01 Adult & 01 Kid
        </h5>
        <div class="flex flex-col items-center justify-start md:flex-row md:text-sm text-xs text-black-200 border-l pl-2 md:pl-4">
  <span class="mb-2 md:mb-0">View:</span>
  <select class="ml-0 md:ml-2 border rounded-sm text-xs h-8 px-2 " v-model="viewDeluxe">
  <option value="mountain">Mountain</option>
  <option value="lake">Lake</option>
</select>      </div>
</div>
    ...
    <div>
      ...
      <div class="flex flex-row gap-4 justify-center mt-2">
        ...
        <div class="flex flex-col items-center justify-start md:flex-row md:text-sm text-xs text-black-200 border-l pl-2 md:pl-4">
  <span class="mb-2 md:mb-0">View:</span>
  <select class="ml-0 md:ml-2 border rounded-sm text-xs h-8 px-2 " v-model="viewDouble">
  <option value="mountain">Mountain</option>
  <option value="lake">Lake</option>
</select>      </div>
</div>
    ...
    <div>
      ...
      <div class="flex flex-row gap-4 justify-center mt-2">
        ...
        <h5 class="md:text-sm text-xs text-black-200 border-l pl-4 mt-[6px]">Beds: 02 Queens</h5>
        <h5 class="md:text-sm text-xs text-black-200 border-l pl-4 mt-[6px]">
            Occupancy: 03 Adults / 02 Adults & 01 Kid / 01 Adults & 02 Kids
        </h5>
        <div class="flex flex-col items-center justify-start md:flex-row md:text-sm text-xs text-black-200 border-l pl-2 md:pl-4">
  <span class="mb-2 md:mb-0">View:</span>
  <select class="ml-0 md:ml-2 border rounded-sm text-xs h-8 px-2 " v-model="viewTriple">
  <option value="mountain">Mountain</option>
  <option value="lake">Lake</option>
</select>      </div>
      </div>
    ...
    <div>
      ...
      <div class="flex flex-row gap-4 justify-center mt-2">
        ...
        <h5 class="md:text-sm text-xs text-black-200 border-l pl-4 mt-[6px]">Beds: 02 Queen</h5>
        <h5 class="md:text-sm text-xs text-black-200 border-l pl-4 mt-[6px]">
            Occupancy: 04 Adults / 02 Adults & 02 Kids
        </h5>
        <div class="flex flex-col items-center justify-start md:flex-row md:text-sm text-xs text-black-200 border-l pl-2 md:pl-4">
  <span class="mb-2 md:mb-0">View:</span>
  <select class="ml-0 md:ml-2 border rounded-sm text-xs h-8 px-2 " v-model="viewFamily">
  <option value="mountain">Mountain</option>
  <option value="lake">Lake</option>
</select>      </div>
      </div>
...
// Use the router inside the setup function
...
const getImageSrcDouble = () => {
  return viewDouble.value === "lake" 
    ? "./img/room_2.jpg"
    : "./img/room_1.jpg";
};
const getImageSrcDeluxe = () => {
  return viewDeluxe.value === "lake" 
  ? "./img/room_5.jpg"
  : "./img/room_3.jpg";
};
