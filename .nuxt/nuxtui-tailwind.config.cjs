      ...
      const { customSafelistExtractor, generateSafelist } = require("D:/Work/CDADEZZ/Resturant/node_modules/@nuxt/ui/dist/runtime/utils/colors")
      ...
      module.exports = {
        ...
        content: {
          files: [
            "D:/Work/CDADEZZ/Resturant/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "D:/Work/CDADEZZ/Resturant/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
