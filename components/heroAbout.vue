<template>
  ...
  <div class="relative">
    ...
    >
      <h6 class="text-white text-2xl font-semibold uppercase mt-32">Learn About US</h6>
      <h2 class="text-white md:text-8xl text-6xl font-semibold lg:mt-36 mt-28 hidden lg:block">
      ...
      <!-- Vertical line -->
      <div class="absolute left-1/2 bottom-0 transform -translate-x-1/2 h-24 w-0.5 bg-slate-300 hidden lg:flex"></div>
    </div>
  </div>
</template>
