<template>
  ...
  <div class="relative">
    ...
    >
      <h6 class="text-white text-xl font-semibold uppercase mt-32">Learn About US</h6>
      <h2 class="text-white md:text-6xl text-5xl font-semibold lg:mt-16 mt-12 hidden lg:block">
        Attention to detail like never before.
      </h2>
      <h6 class="text-white text-xl font-semibold mt-5 uppercase">
        EXPLORE OUR HOTEL
      </h6>
    </div>
  </div>
