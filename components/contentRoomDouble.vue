<template>
  <div class="sm:container px-4 pt-20">
    ...
    <p class="md:text-xl text-base text-gray-300 text-center mt-20 max-w-[80ch] mx-auto">
      ...
      style of Andrew Martin, the renowned British interior designer.</p>
    <p class="md:text-xl text-base text-gray-300 text-center mt-8 max-w-[80ch] mx-auto">
    ...
    <div class="flex flex-row gap-4 justify-center mt-4">
      ...
      <h5 class="md:text-sm text-xs text-black-200 border-l pl-4">
        Beds: 01 Queen Bed / 02 Queen Beds
      </h5>
      <h5 class="md:text-sm text-xs text-black-200 border-l pl-4">
    ...
    >
      <li><strong>Beds:</strong>  01 Queen Bed / 02 Queen Beds.</li>
      <li><strong>Size:</strong> 455 Square Feet</li>
      <li><strong>Views:</strong> Garden.</li>
      <li>
        <strong>Occupancy:</strong> 2 adults, or 1 adult + 1 child
      </li>
    ...
    >
      <div class="flex flex-col gap-4">
        ...
        >
        A warm welcome by the gentle breeze early in the morning is a perfect beginning to the day. The bright chirps of the sun add more elegance to it. All you need is a cup of tea to chill. 
        </h6>
      ...
      <div class="flex flex-col gap-4">
        ...
        <h6
          class="text-sm text-black-200 font-light max-w-[30ch] lg:mx-auto lg:text-center"
        >
        Kickstart the day in a warm and spacious room directed towards the glorious lake view. Enjoy your stay with pleasant surprises until you leave Sueen Nature.
        </h6>
        <h6 class="text-red-100 font-bold text-sm lg:text-center">
          VIEW DETAILS
        </h6>
      ...
      <div class="flex flex-col gap-4">
        ...
        <h6
          class="text-sm text-black-200 font-light max-w-[30ch] lg:mx-auto lg:text-center"
        >
        Wake up with a breathtaking view of lush greenery from your private balcony in one of the most beautiful hotels in Baduraliya. Feel the true sense of relaxation with unique features.
        </h6>
        <h6 class="text-red-100 font-bold text-sm lg:text-center">
          VIEW DETAILS
        </h6>
